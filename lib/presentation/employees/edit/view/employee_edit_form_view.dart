...
class EmployeeEditFormView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EmployeeEditBloc, EmployeeEditState>(
      bloc: bloc,
                            ...
                            child: Column(
                              children: [
                                BaseTextFormField(
                                  ...
                                  onChanged: (value) {
                                    bloc.add(
                                      EmployeeEditEvent.changeEmployeename(
                                        value: value,
                                      ),
                                    );
                                  },
                          ...
                          Expanded(
                            ...
                            child: BaseDropdownButtonField(
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  bloc.add(
                                    EmployeeEditEvent.changeEmployeeType(
                                      value: value,
                                    ),
                                  );
                                }
